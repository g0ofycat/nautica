...
class nn_interface {
  public:
    ...
    static Tensor convolute_image(const std::string &image_path, const size_t convolutions,
    ...
    static std::vector<Tensor> convolute_tensor(const Tensor &input_tensor, const size_t convolutions,
